...
- **Display**: Two-row layout at top of view
  - Row 1: Progress indicators (Section X/Y counter)
  - Row 2: Hierarchical breadcrumb path (H1 › H2 › H3)
...
- `\n` replaced with `§§LINEBREAK§§` marker before splitting
